...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.TabRepository>(() => _i10.TabRepositoryImpl());
    gh.factory<_i11.CommonDatasource>(
        () => _i11.CommonDatasource(postgresModule: gh<_i6.PostgresModule>()));
    gh.factory<_i12.ConfigRepository>(() =>
        _i13.ConfigRepositoryImpl(datasource: gh<_i11.CommonDatasource>()));
    gh.factory<_i14.DeleteConfigByIdUsecase>(() => _i14.DeleteConfigByIdUsecase(
        configRepository: gh<_i12.ConfigRepository>()));
    gh.factory<_i15.EditConfigUsecase>(
        () => _i15.EditConfigUsecase(repository: gh<_i12.ConfigRepository>()));
    gh.factory<_i16.GetAllConfigsUseCase>(() => _i16.GetAllConfigsUseCase(
        configRepository: gh<_i12.ConfigRepository>()));
    gh.factory<_i17.AddConfigUsecase>(() =>
        _i17.AddConfigUsecase(configRepository: gh<_i12.ConfigRepository>()));
    gh.singleton<_i18.ConfigController>(_i18.ConfigController(
        getAllConfigsUseCase: gh<_i16.GetAllConfigsUseCase>()));
    return this;
  }
}
